...
- changesets?
- vanilla css / atomic or css-in-js. 
- React? or html?
- styled system! System props!
- theme support is a must have. Dark mode/multi-brand

- treat / glaze https://github.com/kripod/glaze / https://github.com/atlassian-labs/compiled-css-in-js

- web components? stencil? Is 


Long term is react the right choice?